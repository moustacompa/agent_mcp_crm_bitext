...
\chapter{Sélection et analyse des datasets}
...
\section{92k Call Center Scripts}
...
\section{Bitext Customer Support Chatbot}
...
\chapter{Étapes du processus de réalisation}

\section{Étape 1 : téléchargement ou placement du dataset}
...
\screenshotplaceholder{Capture 1 -- Téléchargement du dataset}{Exécution de \texttt{python scripts/download\_dataset.py}.}

\section{Étape 2 : préparation des données}
...
\screenshotplaceholder{Capture 2 -- Préparation des données}{Exécution de \texttt{python scripts/prepare\_data.py} et génération des fichiers.}

\section{Étape 3 : analyse exploratoire}
...
\screenshotplaceholder{Capture 5 -- Matrice de confusion}{Fichier \texttt{confusion\_matrix.png}.}

\chapter{Architecture MCP}
...
\chapter{Classificateur d'intentions}
...
\chapter{Choix du modèle Ollama}
...
\chapter{Dépendances et environnements}
...
\chapter{État final d'avancement}

\section{Éléments finalisés}
...
\section{Éléments partiellement réalisés}
...
\chapter{Liste des captures d'écran à intégrer}
